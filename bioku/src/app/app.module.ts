...
import { CsampleBasicDetailComponent } from './containers/csample-basic-detail/csample-basic-detail.component';
...
@NgModule({
  declarations: [
    ...
    CsampleBasicDetailComponent,
    CsampleManageComponent,
  ],
  imports: [
    BrowserModule,
    FormsModule,

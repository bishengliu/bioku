...
export class DeleteGroupComponent implements OnInit {
  ...
  constructor(private alertService: AlertService, private route: ActivatedRoute, @Inject(APP_CONFIG) private appSetting: any, @Inject(AppStore) private appStore, 
              private router: Router, private logAppStateService: LogAppStateService, private groupService: GroupService)
  { 
  ...
  deleteGroup(pk: number): void
  {
   ...
   console.log(pk);
    ...
    .subscribe(
      data=> this.alertService.success('Group deleted!', true),
